...
public class KneatTests {
	...
	public void setup()
	{
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\diarm\\Documents\\Selenium\\chromedriver.exe");
	...
	public void saunaFilter() throws InterruptedException, NoSuchElementException
	{
		...
		//Checking if the faulty 'Show all 13' filter has loaded and if so, to restart the process
		//List<WebElement> incorrectShowFilter = driver.findElements(By.partialLinkText("Show all 13"));
		/*
		List<WebElement> incorrectShowFilter = driver.findElements(By.xpath("//button[text()='\r\nShow all 13']"));
		if(incorrectShowFilter.size() > 0)
		{
			System.out.println("The Show all 13 filter appeared");
			//driver.navigate().back();
			driver.close();
		}
		*/
		//Select the 'Show More' button to bring up the options the will include 'Sauna'
		//WebElement showMore = driver.findElement(By.cssSelector("button[data-et-click='customGoal:OLGHIDSJPXe:2']"));
		//WebElement showMore = driver.findElement(By.xpath("button[text()='Show more']"));
	...
	public void bookFlight() throws InterruptedException
	{
		...
		{
			System.out.println(price + " - not a bad price.");
		}
		else
		{
			System.out.println(price + " - bit steep.");
		}
